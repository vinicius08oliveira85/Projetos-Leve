...
const PacientesAguardandoExame = ({ onBack, onViewDetails, user, patients, onUpdatePatients, showToast }: { 
    onBack: () => void, 
                            ...
                            <tr key={p.id}>
                                ...
                                <td>
                                    {user.role === 'admin' ? (
                                        ...
                                        formatDateDdMmYy(p.desdeExame)
                                    )}
                                </td>
                                <td>{calculateDaysWaiting(p.desdeExame)}</td>
